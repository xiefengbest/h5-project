...
├── minus-one/news-list.html       负一屏 v1
...
| 来源 | 目标 |
|------|------|
| 负一屏 v1 `news-list.html` | 点击条目 → `web-anyselected/index.html?id=N` |
...
*本地预览：直接打开 `pages/` 下对应 HTML。可选 `bash scripts/deploy.sh` 复制到 `dist/` 打包分享。*
